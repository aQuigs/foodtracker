function u(e, t) {
  ...
  return e.mode === "navigate" && (a === t.scope || a === l(t.scope)) ? "shell" : t.precached.has(a) ? "precached" : "network";
}
function l(e) {
  return `${e}index.html`;
}
...
var k = { base: "/foodtracker/pr-previews/pr-74/", paths: ["/foodtracker/pr-previews/pr-74/apple-touch-icon.png", "/foodtracker/pr-previews/pr-74/assets/index-DsdOlrp1.css", "/foodtracker/pr-previews/pr-74/assets/index-IPomHIXZ.js", "/foodtracker/pr-previews/pr-74/favicon-32.png", "/foodtracker/pr-previews/pr-74/favicon.svg", "/foodtracker/pr-previews/pr-74/icon-192.png", "/foodtracker/pr-previews/pr-74/icon-512.png", "/foodtracker/pr-previews/pr-74/index.html", "/foodtracker/pr-previews/pr-74/manifest.webmanifest"], hash: "46bbb7dd" };
...
self.addEventListener("activate", (e) => {
  e.waitUntil(b().then(() => self.clients.claim()));
});
