...
- `EditFood` with `{ foodId: string, updates: Partial<Pick<Food, 'name' | 'kcalPer100g' | 'proteinPer100g' | 'carbsPer100g' | 'fatPer100g'>> }` — patches the food in place, rejects unknown id, rejects invalid nutrition
