...
10. Card: changing Egg to 2 and Servings to 2 updates the Total to 2×(2 eggs + 2 oz ham) and shows `2×` inside each amount field, hidden again at Servings 1; a blank or 0 amount shows `—` and is skipped on log.
