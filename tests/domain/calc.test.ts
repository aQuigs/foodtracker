...
describe('entryCalories', () => {
  it('computes calories as (nutritionFacts.calories * grams) / 100', () => {
    const e: Entry = { id: 'e1', date: '2026-05-23', foodId: 'f1', amount: 120, unit: 'g', grams: 120, loggedAt: '2026-05-23T10:00:00Z' };
    expect(entryCalories(e, banana)).to.be.closeTo(106.8, 0.0001);
  });

  it('returns 0 for 0 grams', () => {
    const e: Entry = { id: 'e1', date: '2026-05-23', foodId: 'f1', amount: 0, unit: 'g', grams: 0, loggedAt: '2026-05-23T10:00:00Z' };
...
describe('dailyTotals', () => {
  const state: State = {
    ...
    entries: [
      ...
      { id: 'e2', date: '2026-05-23', foodId: 'f2', amount: 50, unit: 'g', grams: 50,  loggedAt: '2026-05-23T09:00:00Z' },
      { id: 'e3', date: '2026-05-22', foodId: 'f1', amount: 200, unit: 'g', grams: 200, loggedAt: '2026-05-22T08:00:00Z' },
    ],
  };
  ...
  it('ignores entries whose food is missing', () => {
    const orphan: State = {
      version: 2, foods: [],
      entries: [{ id: 'e1', date: '2026-05-23', foodId: 'missing', amount: 100, unit: 'g', grams: 100, loggedAt: '2026-05-23T08:00:00Z' }],
    };
  ...
  it('still counts entries against soft-deleted foods (historical render contract)', () => {
    ...
    const s: State = {
      ...
      entries: [{ id: 'e1', date: '2026-05-23', foodId: 'f1', amount: 100, unit: 'g', grams: 100, loggedAt: '2026-05-23T08:00:00Z' }],
    };
