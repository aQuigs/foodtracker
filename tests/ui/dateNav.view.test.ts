...
describe('date navigation in view', () => {
  ...
  it('date input value reflects selectedDate', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: '2026-05-20', query: '', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
  ...
  it('entry list filters by selectedDate, not today', () => {
    ...
    render(container, { ...baseVm, state, today, selectedDate: '2026-05-22', query: '', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
  ...
  it('fires onJumpToday when today shortcut clicked', () => {
    let fired = false;
    render(container, { ...baseVm, state: freshState(), today, selectedDate: '2026-05-20', query: '', selectedFoodId: null, gramsRaw: '', error: null }, {
      ...noopHandlers,
