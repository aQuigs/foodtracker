...
describe('render', () => {
  ...
  it('renders search input, grams input, and log button', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
  ...
  it('filters food picker by query (case-insensitive substring)', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: 'ban', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
    const items = container.querySelectorAll('[data-testid="food-option"]');
  ...
  it('renders entry rows with name, grams, integer-rounded cal', () => {
    ...
    render(container, { ...baseVm, state, today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
    const rows = container.querySelectorAll('[data-testid="entry-row"]');
  ...
  describe('totals row', () => {
    ...
    it('renders each nutrient on its own line (one <li> per nutrient)', () => {
      render(container, { ...baseVm, state: stateWithBanana, today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
  ...
  it('renders error message when error is set', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '', error: 'Pick a food.' }, noopHandlers);
  ...
  it('selected food option is marked as selected', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: 'seed-banana', gramsRaw: '', error: null }, noopHandlers);
  ...
  it('preserves query and gramsRaw in inputs across renders', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: 'oat', selectedFoodId: null, gramsRaw: '42', error: null }, noopHandlers);
  ...
  it('fires onLog with current form values when log button is clicked', () => {
    ...
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: 'seed-banana', gramsRaw: '100', error: null }, {
      ...noopHandlers,
  ...
  it('fires onDelete with entry id when delete button is clicked', () => {
    ...
    render(container, { ...baseVm, state, today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '', error: null }, {
      ...noopHandlers,
  ...
  it('fires onQueryChange when search input changes', () => {
    let last = '';
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '', error: null }, {
      ...noopHandlers,
  ...
  it('preserves focus on the same input across renders', () => {
    ...
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: null, gramsRaw: '1', error: null }, noopHandlers);
  ...
  it('preserves caret position on text-like inputs across renders', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: 'oat', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
    const search1 = container.querySelector('[data-testid="search-input"]') as HTMLInputElement;
    search1.focus();
    search1.setSelectionRange(2, 2);

    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: 'oats', selectedFoodId: null, gramsRaw: '', error: null }, noopHandlers);
