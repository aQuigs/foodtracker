...
describe('render', () => {
  ...
  it('filters food picker by query (case-insensitive substring)', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: 'ban', selectedFoodId: null, amount: '', error: null }, noopHandlers);
    const items = container.querySelectorAll('[data-testid="food-option"]');
  ...
  it('renders entry rows with name, grams, integer-rounded cal', () => {
    ...
    render(container, { ...baseVm, state, today, selectedDate: today, query: '', selectedFoodId: null, amount: '', error: null }, noopHandlers);
    const rows = container.querySelectorAll('[data-testid="entry-row"]');
  ...
  describe('totals row', () => {
    ...
    it('renders each nutrient on its own line (one <li> per nutrient)', () => {
      render(container, { ...baseVm, state: stateWithBanana, today, selectedDate: today, query: '', selectedFoodId: null, amount: '', error: null }, noopHandlers);
  ...
  it('selected food option is marked as selected', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: '', selectedFoodId: 'seed-banana', amount: '', error: null }, noopHandlers);
  ...
  it('fires onDelete with entry id when delete button is clicked', () => {
    ...
    render(container, { ...baseVm, state, today, selectedDate: today, query: '', selectedFoodId: null, amount: '', error: null }, {
      ...noopHandlers,
  ...
  it('does not clobber the caret on a focused input when re-rendering with the same value', () => {
    render(container, { ...baseVm, state: freshState(), today, selectedDate: today, query: 'oat', selectedFoodId: null, amount: '', error: null }, noopHandlers);
